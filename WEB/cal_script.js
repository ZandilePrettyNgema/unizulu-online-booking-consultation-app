...
function addEvents(title, from, to){
  
  const eventTitle = title;
  const eventTimeFrom = from;
  const eventTimeTo = to;
...
function clearCalendar(dateString){
...
function returnEvents(){
  const dbRefE = ref(getDatabase());
        get(child(dbRefE, `appointments`)).then((snapshot) => {
          ...
          snapshot.forEach(function(childSnapshot) {
            ...
            let booking = {
                  ...
                  "title": childSnapshot.val().cname +"\n"+childSnapshot.val().module +"\n"+childSnapshot.val().title+"\n"+childSnapshot.val().time,
            }
